...
INSERT INTO categoria VALUES (1, 'Remeras');
INSERT INTO subcategoria VALUES (1, 'Training', 1);
INSERT INTO subcategoria VALUES (2, 'Deporte', 1);

INSERT INTO categoria VALUES (2, 'Zapatillas ');
INSERT INTO subcategoria VALUES (3, 'Running', 2);
INSERT INTO subcategoria VALUES (4, 'Urban', 2);

INSERT INTO producto VALUES (1,'REMERA ADIDAS 25/7 RISE UP N RUN PARLEY BLANCA','Esta Remera se ha confeccionado en un tejido suave y transpirable con hilo reciclado proveniente del plástico recogido en playas y zonas costeras antes de que llegue al océano.',0,true,4299,'40EM-18595490','/img/100020fl6818001-1.jpg',true,1);
INSERT INTO producto VALUES (2,'REMERA UNDER ARMOUR TECH GRAPHIC MUJER LILA','La tecnología Heatgear es un tejido súper transpirable que absorbe el sudor y regula la temperatura del cuerpo para que te sientas más fresca, seca y ligera que nunca.',0,false,2799,'20EM-1000090102','/img/remera-under-armour-tech-graphic-mujer-lila-700021356282694-1.jpg',true,1);
INSERT INTO producto VALUES (3,'REMERA UNDER ARMOUR SPORTSTYLE LEFT CHEST AZUL','La tecnología Heatgear es un tejido súper transpirable que absorbe el sudor y regula la temperatura del cuerpo para que te sientas más fresca, seca y ligera que nunca.',0,true,2799,'20EM1536513061','/img/remera-under-armour-sportstyle-left-chest-azul-700021354534438-1.jpg',true,1);
INSERT INTO producto VALUES (4,'CASACA VAIRO RAVEN MUJER NEGRA','Lográ tus objetivos con la comodidad y el estilo único de VAIRO.',0,true,1719,'10AS-416757829','/img/715020222001017-1_1.jpg',true,2);
INSERT INTO producto VALUES (5,'ZAPATILLA ADIDAS ADIZERO ADIOS 5 ROSA','Adopta la velocidad con estas zapatillas ADIDAS diseñadas para entrenar y competir rápidamente. Una parte superior de malla de peso pluma tiene un sistema de ajuste interno para un bloqueo con una sensación de apenas presencia.',0,true,15499,'10AP-505375209','/img/100010eg4667001-1.jpg',true,3);
INSERT INTO producto VALUES (6,'ZAPATILLA ADIDAS RUNFALCON MUJER BLANCA','Una mediasuela liviana amortigua tus pasos, mientras la suela de caucho con agarre te proporciona tracción en superficies interiores o exteriores.',0,false,5799,'50AP760204175','/img/zapatilla-adidas-runfalcon-mujer-blanca-100010fw5142001-1.jpg',true,3);
INSERT INTO producto VALUES (7,'ZAPATILLA ADIDAS VL COURT 2.0 NEGRA','Debido a la naturaleza de exclusiva calidad de la piel y el ante, podría ocurrir que en algunos casos el producto destiñera levemente, sobre todo en condiciones de humedad.',0,true,7199,'70AP342280525','/img/100010eg3965001-1.jpg',true,4);
